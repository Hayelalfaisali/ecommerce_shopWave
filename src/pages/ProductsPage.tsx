...
const ProductPage: React.FC = () => {
  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <Link to="/shop" className="text-gray-600 hover:text-shop-blue inline-flex items-center">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-16">
          ...
          <div className="md:w-1/2">
            ...
            <span className="text-2xl font-bold text-shop-blue mb-6 block">
            ...
            <button
              ...
              className={`w-full py-3 rounded-md font-medium text-white ${
                product.stock 
                  ? 'bg-shop-blue hover:bg-blue-600'
