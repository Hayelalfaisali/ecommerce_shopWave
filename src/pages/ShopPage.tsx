          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div className="relative w-full md:w-auto flex-grow max-w-md">
              <input
                ...
                className="w-full px-4 py-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-text-indigo-500 focus:border-transparent"
              />
            ...
            <div className="flex w-full md:w-auto items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-4 py-2 border cursor-pointer border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-text-indigo-500 focus:border-transparent"
                >
